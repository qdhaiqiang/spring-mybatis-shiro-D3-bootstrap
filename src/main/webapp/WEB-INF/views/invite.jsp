...
<div class="page-content">
    ...
    <!-- Default panel -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">邀请次数、人数对比图</h6></div>
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['邀请量'<c:forEach var="item" items="${chartData}">,${item.value}</c:forEach>],
                ['邀请人数'<c:forEach var="item" items="${chartUserData}">,${item.value}</c:forEach>]
            ]
        },
        axis: {
            x: {
