...
<div class="page-content">
    ...
    <div class="panel panel-default">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${qiugous}" var="item">
                    <tr>
                        <td>${item.id}</td>
                        <td>${item.name}</td>
                        <td>${item.datetime}</td>
    ...
    <!-- Default panel -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">求购次数、人数对比图</h6></div>
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['求购量'<c:forEach var="item" items="${chartData}">,${item.value}</c:forEach>],
                ['求购人数'<c:forEach var="item" items="${chartUserData}">,${item.value}</c:forEach>]
            ]
        },
        axis: {
            x: {
