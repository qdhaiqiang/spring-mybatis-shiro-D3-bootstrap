...
<div class="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">数据可视化</h6>
            <div class="btn-group btn-group-justified">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary">黑色：被举报的车辆</button>
                </div>
                <div class="btn-group">
                    <button type="button" class="btn btn-success">绿色：车辆所属商户</button>
                </div>
                <div class="btn-group">
                    <button type="button" class="btn btn-danger">红色：举报人</button>
                </div>
            </div>
        </div>
    ...
    <!-- Default panel -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">被举报车辆、人数对比图</h6></div>
...
<script type="text/javascript">
    ...
    d3.json("/rest/charts/reportDataInJson?from=2015-02-10&to=2015-03-10", function(error, graph) {
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['被举报车辆'<c:forEach var="item" items="${chartData}">,${item.value}</c:forEach>],
                ['举报人数'<c:forEach var="item" items="${chartUserData}">,${item.value}</c:forEach>]
            ]
        },
        axis: {
            x: {
