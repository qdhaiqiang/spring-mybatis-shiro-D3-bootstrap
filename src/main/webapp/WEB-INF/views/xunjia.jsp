...
<div class="page-content">
    ...
    <div class="panel-heading"><h6 class="panel-title"><i class="icon-bubble4"></i> 询价数据查询</h6></div>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="icon-user"> 询价人姓名</i></span>
    ...
    <!-- Default table -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title"><i class="icon-table2"></i> 询价表格</h6></div>
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${xunJias}" var="item">
                    <tr>
                        <td>${item.xunJiaId}</td>
                        <td>${item.xunJiaName}</td>
                        <td>${item.beiXunjiaId}</td>
                        <td>${item.beiXunjiaName}</td>
                        <td>${item.date}</td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <!-- Default panel -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">询价涟漪图</h6></div>
    ...
    <!-- Default panel -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">询价折线图</h6></div>
...
<script type="text/javascript">
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['询价次数'<c:forEach var="item" items="${chartData}">,${item.value}</c:forEach>],
                ['询价人数'<c:forEach var="item" items="${chartUserData}">,${item.value}</c:forEach>]
            ]
        },
        axis: {
            x: {
    ...
    var links = [
        <c:forEach items="${xunJias}" var="item">
            {source: "${item.xunJiaName}", target: "${item.beiXunjiaName}", type: "licensing"},
        </c:forEach>
        {source: "安国", target: "陈勇", type: "resolved"}
    ];
